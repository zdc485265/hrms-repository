					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">新增职位</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#jobAdd">新增</a>
															</li>
														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																   <p style="color: red;"> ${requestScope.job_add_msg }</p>
																	<form action="${pageContext.request.contextPath }/job/addJob.gkd" method="post" class="form-horizontal" role="form">
																													
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">职位编码：</label>

																			<div class="col-sm-9">
																				<input name="job_code" type="text" id="form-field-2" placeholder="职位编码    例：BDQN-BM03" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="job_name" type="text" id="form-field-1" placeholder=" 职位名    例：技术培训师" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<textarea name="job_description" placeholder="职位描述    例：培训员工技术的人员" id="form-field-1" rows="3" cols="80" class="col-xs-10 col-sm-5"></textarea><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<textarea name="job_remark" placeholder="职位备注   例：有好的培训人员，才有高技术的员工" id="form-field-1" rows="3" cols="80" class="col-xs-10 col-sm-5"></textarea><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
