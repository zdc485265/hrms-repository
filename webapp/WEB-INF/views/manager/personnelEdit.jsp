					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">人事档案变更</h4>
														...
														<div class="tab-content padding-4">
															...
															<div id="recruitPersonnelAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																    <p style="color: red;">${requestScope.personnel_edit_msg }</p>
																	<form action="${pageContext.request.contextPath }/personnel/editPersonnel.gkd" method="post" class="form-horizontal" role="form">
																	    <input name="personnel_id" value="${personnel.personnel_id }" type="hidden"/>
																	    <table style="margin-left: 200px">
																	    	...
																	    	<tr>
																							...
																							<select name="personnel_status">
																								<c:choose>
																									<c:when test="${personnel.personnel_status==0 }">
																										...
																										<option value="${personnel.personnel_status+4 }">删除</option>
																									</c:when>
																									...
																									<c:when test="${personnel.personnel_status>3 }">
																										...
																										<option value="2">正式</option>
																										<option value="3">离职</option>
																										<option value="${personnel.personnel_status+4 }" selected="selected">删除</option>
																									</c:when>
																								</c:choose>
																							</select>
																						</div>
																	    		...
																	    		<td style="width:400px;" rowspan="4">
																	    			<div class="form-group">
																	    				<input id="personnelPhoto" name="personnel_photo" type="hidden" value="${personnel.personnel_photo }">
																	    				<span id="spanPhoto" class="profile-picture" style="width: 155px;height: 165px;">
																							<img id="personnelImg" style="width: 150px;height: 160px;" class="editable img-responsive editable-click editable-empty" alt="Alex's Avatar" src="/file/${personnel.personnel_photo }">
																						</span>
																						<span id="spanFile" style="display: none;">
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" style="width: 150px;" value="${personnel.job.job_code }" name="job_code" type="text" id="jobCode" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px;">
																	    	...
																	    	<%--第三行 --%>
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:100px;" name="personnel_name" value="${personnel.personnel_name }" type="text" placeholder=" 姓名 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px;">
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" value="${personnel.personnel_email }" name="personnel_email" type="text" id="form-field-1" placeholder=" EMAIL " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_phone" type="text" value="${personnel.personnel_phone }" placeholder=" 联系电话 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    	...
																	    	<tr>
																	    		<td style="width:400px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:300px;" name="personnel_address" type="text" value="${personnel.personnel_address }"  placeholder=" 住址 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:160px;" name="personnel_identify" value="${personnel.personnel_identify }" type="text" placeholder=" 身份证号 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_hokou_address" type="text" value="${personnel.personnel_hokou_address }"  placeholder=" 户口所在地 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_zzmm" type="text" value="${personnel.personnel_zzmm }" placeholder=" 政治面貌 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_school" type="text" value="${personnel.personnel_school }" placeholder=" 毕业院校 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_major" type="text" value="${personnel.personnel_major }" placeholder=" 专业 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px"><div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_bank" value="${personnel.personnel_bank }" type="text" placeholder=" 开户行 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_bank_card" value="${personnel.personnel_bank_card }" type="text" placeholder=" 银行卡号" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_social_security_card" value="${personnel.personnel_social_security_card }" type="text" placeholder=" 社保卡号 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px"><div class="form-group">
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="personnel_register_date" value="${requestScope.personnel.personnel_register_date }" placeholder=" 建档时间" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="layd ate({istime: true, format: 'YYYY-MM-DD'})"/>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:600px;height: 100px;left: 10px" name="personnel_identify_info">${personnel.personnel_identify_info }</textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:600px;height: 100px;left: 10px" name="personnel_family_info">${personnel.personnel_family_info }</textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:600px;height: 100px;left: 10px" name="personnel_remarks">${personnel.personnel_remarks }</textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="1">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input id="personnelResumeInfo" name="personnel_resume_info" value="${personnel.personnel_resume_info }" type="hidden"/>
																							<div style="position: relative;float: left;size:30px;">
																								<input id="img" name="img" value="${personnel.personnel_resume_info }" type="file" />
																							</div>
																							<div style="position: relative;float: left;size:30px;">
																			...
																			<div class="col-sm-7 text-right">
																				<c:choose>
																					<c:when test="${personnel.personnel_examine_status==0 }">
																						<button type="submit" name="personnel_examine_status" value="0" class="btn btn-primary">变更</button>&nbsp;&nbsp;<button type="submit" name="personnel_examine_status" value="1" class="btn btn-primary">申请</button>
																					</c:when>
																					<c:when test="${personnel.personnel_examine_status==1 }">
																						<c:forEach var="power" items="${sessionScope.admin.role.powers }">
																							<c:if test="${power.power_action=='examine' and power.power_url=='personnel' }">
																								<button type="submit" name="personnel_examine_status" value="2" class="btn btn-primary">审核通过</button>&nbsp;&nbsp;<button type="submit" name="personnel_examine_status" value="0" class="btn btn-primary">驳回</button>
																							</c:if>
																						</c:forEach>
																					</c:when>
																					<c:when test="${personnel.personnel_examine_status==2 }">
																						<button type="submit" name="personnel_examine_status" value="1" class="btn btn-primary">变更申请</button>
																					</c:when>
																				</c:choose>
																			</div>
																		</div>
