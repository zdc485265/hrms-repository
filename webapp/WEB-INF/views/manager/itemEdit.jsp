					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">编辑薪酬项目</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#itemEdit">编辑</a>
															</li>

													

															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/item/toItemList.gkd'">列表</a>
															</li>
														</ul>
													</div>
												</div>

																  <p style="color: red;">${requestScope.item_edit_msg }</p>
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4" style="top: 50px;">
														
															<div id="itemEdit" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	<form action="${pageContext.request.contextPath }/item/editItem.gkd" method="post" class="form-horizontal" style="width: 700px;margin-left: 400px;" role="form">
																	    <%--注意：更新必须要有管理员编号 --%>
																	    <input name="item_id" value="${requestScope.item.item_id }" type="hidden">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 薪酬项目名 </label>

																			<div class="col-sm-9">
																				<input name="item_name" value="${requestScope.item.item_name }" type="text" id="form-field-1" placeholder="薪酬项目名   例：薪酬项目" class="col-xs-10 col-sm-5" style="width: 210px;" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="item_sort" value="${requestScope.item.item_sort }" type="text" id="form-field-1" placeholder="排序序号   例：1 " class="col-xs-10 col-sm-5" style="width: 210px;" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right" style="width: 344px;">
																				<button type="submit"  class="btn btn-primary">编辑薪酬项目</button>
																			</div>
																		</div>
																	</form>
