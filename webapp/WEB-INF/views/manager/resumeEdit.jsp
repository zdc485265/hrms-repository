					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">简历登记变更</h4>
														...
														<div class="tab-content padding-4">
															...
															<div id="recruitResumeAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																    <p style="color: red;">${requestScope.resume_edit_msg }</p>
																	<form action="${pageContext.request.contextPath }/resume/editResume.gkd" method="post" class="form-horizontal" role="form">
																	    ...
																	    <table>
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" style="width:140px;" id="jobCode" name="jobCode" type="text" id="form-field-1" value="${resume.job.job_code }" class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" style="width:100px;" id="classifyName" name="classify_name" type="text" id="form-field-1" value="${resume.job.classify.classify_name}" class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		</tr>
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_name" type="text" id="form-field-1" value="${resume.resume_name }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px;">
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							...
																							<c:choose>
																									<c:when test="${resume.recruit.recruit_sort==0 }">
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_email" type="text" id="form-field-1" value="${resume.resume_email }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_phone" type="text" id="form-field-1" value="${resume.resume_phone }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:100px;" name="resume_hokou_address" type="text" id="form-field-1" value="${resume.resume_hokou_address }" class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:400px" colspan="1">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:300px;" name="resume_address" type="text" id="form-field-1" value="${resume.resume_address }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:100px;" name="resume_zzmm" type="text" id="form-field-1" value="${resume.resume_zzmm }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:160px;" name="resume_identity" type="text" id="form-field-1"  value="${resume.resume_identity }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_school" type="text" id="form-field-1"  value="${resume.resume_school }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_major" type="text" id="form-field-1"  value="${resume.resume_major }" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:150px;" name="resume_experience" type="text" id="form-field-1"  value="${resume.resume_experience }" class="col-xs-10 col-sm-5" />(例如：5  表示5年)<p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input style="width:100px;" name="resume_sal_req" type="text" id="form-field-1"  value="${resume.resume_sal_req }" class="col-xs-10 col-sm-5" />(月薪)<p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<select name="resume_is_inword">
																							<c:choose>
																								<c:when test="${resume.resume_is_inword==0 }">
																	    		...
																	    		<td style="width:400px"><div class="form-group">
																						...
																						<select name="resume_is_current">
																							<c:choose>
																								<c:when test="${resume.resume_is_current==0 }">
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="resume_login_date" class="form-control layer-date" placeholder="YYYY-MM-DD" value="${resume.resume_login_date }" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:600px;height: 100px;left: 10px" name="resume_identity_info" rows="" cols="">${resume.resume_identity_info }</textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="1">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input id="resume_info" name="resume_info" value="${resume.resume_info }" type="hidden"/>
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px"><div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="admin_id" value="${resume.admin.admin_id }" type="hidden">
																							<input name="admin_account" value="${resume.admin.admin_account }" readonly="readonly" type="text"/>
																						</div>
																					</div>
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="resume_recommend_date" value="${resume.resume_recommend_date }" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:600px;height: 100px;left: 10px" name="resume_suggest">${resume.resume_suggest }</textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">修改登记</button>
																			</div>
																		</div>
																	</form>
				...
				$("#shangchuan").click(function(){
					...
					$.ajax({
						...
						success: function (data) {
							console.log(data);
							if(data.msgStatus==0){
								$("#recruitResumeInfo").val(data.msgInfo);
