					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">职位发布登记</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#recruitJobAdd">登记</a>
															</li>
												...
												<p style="color: red;">${requestScope.recruit_add_msg }</p>
														...
														<div class="tab-content padding-4">
															...
															<div id="recruitJobAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	...
																	<form action="${pageContext.request.contextPath }/recruit/addRecruit.gkd" method="post" class="form-horizontal" role="form">
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="recruit_num" type="text" id="form-field-1" placeholder=" 招聘人数 " class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" id="jobCode" name="job_code" type="text" id="form-field-1" placeholder=" 职位编码 " class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" id="classifyName" name="classify_name" type="text" id="form-field-1" placeholder=" 职位分类 " class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							...
																							<input name="admin_account" readonly="readonly" type="text" value="${sessionScope.admin.admin_account }" id="form-field-1" placeholder=" 登记人 " class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input value="${requestScope.newDate }" id="recruitStart" name="recruit_start" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input value="${requestScope.newDate }" id="recruitEnd" name="recruit_end" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="3">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea readonly="readonly" style="width:1000px;height: 140px;left: 10px" id="jobDescription" name="job_description"></textarea>
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	...
																	    	<tr>
																	    		<td style="width:500px" colspan="3">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<textarea style="width:1000px;height: 140px;left: 10px" name="recruit_req" ></textarea>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">发布登记</button>
																			</div>
																		</div>
																	</form>
