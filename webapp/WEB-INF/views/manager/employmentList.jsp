					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">录用列表</h4>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
													        ...
													        <p style="color: red;">${requestScope.employment_list_msg }</p>
															<div id="employmentList" class="tab-pane in active">
																		  ...
																		  <td>${resume.resume_major }</td>
																		   <td>${resume.job.job_name }</td>
																		    ...
																		    <c:choose>
																		  	...
																		  	<td><a href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath}/employment/toRegisterEmployment.gkd?resume_id=${resume.resume_id }'">录用登记</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath}/employment/toEmploymentDetailed.gkd?resume_id=${resume.resume_id}'" >明细</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath}/employment/deleteEmployment.gkd?resume_id=${resume.resume_id}'">删除</a></td>
																		</tr>
																	</c:forEach>
																 ...
																 <div class="text-right">
																	 <nav>
																	  <ul class="pagination">
																	 <li>
																		                <a href="${pageContext.request.contextPath }/employment/toEmploymentList.gkd?index=0">首页</a>
																		                </li>
																	      <c:choose>
																	         <c:when test="${requestScope.page.previous }">
																	                 <li>
																	               <a href="${pageContext.request.contextPath }/employment/toEmploymentList.gkd?index=${requestScope.page.index-1 }&searchValue=${searchValue }" aria-label="Previous">
																		...
																		<c:forEach begin="1" varStatus="status" end="${requestScope.page.totalPage }">
																		     ...
																		     <c:if test="${status.count>=s&&status.count<=e }">
																		       <c:choose>
																		          ...
																		          <c:when test="${status.count==requestScope.page.index+1}">
																		      			...
																		      			<li class="active">
																		      			<a href="${pageContext.request.contextPath }/employment/toEmploymentList.gkd?index=${status.count-1}">${status.count }</a>
																		      			</li>										          
																		          </c:when>
																		          <c:otherwise>
																		                <li>
																	     ...
																	     <c:choose>
																	        <c:when test="${requestScope.page.next }">
																	           <li>
																	             <a href="${pageContext.request.contextPath }/employment/toEmploymentList.gkd?index=${requestScope.page.index+1}&searchValue=${searchValue }" aria-label="Next">
																	     ...
																	     <li>
																		                <a href="${pageContext.request.contextPath }/employment/toEmploymentList.gkd?index=${requestScope.page.totalPage-1}">尾页</a>
																		                </li>
																	  </ul>
																	</nav>
																</div>
