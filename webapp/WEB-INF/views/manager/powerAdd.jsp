												...
												<div class="widget-header">
													...
													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#powerAdd">新增</a>
															</li>
													...
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<div id="powerAdd" class="tab-pane in active ">
																...
																<p style="color: red;">${requestScope.power_add_msg }</p>
																	<form action="${pageContext.request.contextPath }/power/addPower.gkd" method="post" class="form-horizontal" role="form">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 权限名 :</label>

																			<div class="col-sm-9">
																				<input  name="power_name"   type="text" id="form-field-1" placeholder="权限名   例:权限管理" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="power_action" type="text" id="form-field-1" placeholder="请求路径   例:addPower.gkd" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="power_url" type="text" id="form-field-1" placeholder="URL  例:power" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																		<div class="form-group">
