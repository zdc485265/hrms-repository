					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">薪酬标准变更</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#toEditSalaryStandard">变更</a>
															</li>
															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/salary/toSalaryList.gkd'">列表</a>
															</li>
														</ul>
													</div>
												</div>
													...
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<div class="scrollable-horizontal" data-size="800">
																    <p style="color: red;">${requestScope.salary_edit_msg }</p>
																	<form  action="${pageContext.request.contextPath }/salary/editSalary.gkd" method="post" class="form-horizontal" role="form">
																	    <input name="salary_id" value="${requestScope.salary.salary_id }" type="hidden">
																	    <%--注意：更新必须要有管理员编号 --%>
																		<table>
																	    	<tr>
																	    		<td style="width:450px">
																					<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_code" type="text" value="${requestScope.salary.salary_code }" id="form-field-1" placeholder="薪酬标准编号" class="col-xs-10 col-sm-5" style="width: 210px" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_name" type="text" placeholder="薪酬标准名称" value="${requestScope.salary.salary_name }" class="col-xs-10 col-sm-5" style="width: 210px" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																		    		<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_total" id="salaryTotal" readonly="readonly" value="${requestScope.num }" type="text" placeholder="薪酬总额" class="col-xs-10 col-sm-5" style="width: 210px" />
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	    	<tr>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_marker" type="text" placeholder="制定人" value="${requestScope.salary.salary_marker }" class="col-xs-10 col-sm-5" style="width: 210px" /><p style="color: red;">*</p>
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    		...
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_date" class="form-control layer-date" value="${requestScope.salary.salary_date }" placeholder="YYYY-MM-DD" style="width: 210px" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																			...
																			<c:forEach var="item" varStatus="status" items="${requestScope.items }">
																	  			...
																	  			<tr class="bolder">
																					...
																					<td>
																						...
																						<input name="salary_item_value" type="text" value="${item.salary_item_value }" placeholder="金额" class="col-xs-10 col-sm-5 salaryItemValue" />
																				...
																				<c:choose>
																					...
																					<c:when test="${salary.salary_status==1 }">
																						<c:forEach var="power" items="${sessionScope.admin.role.powers }">
																							<c:if test="${power.power_action=='examine' and power.power_url=='salary' }">
																								<button type="submit" name="salary_status" value="2" class="btn btn-primary">审核通过</button>&nbsp;&nbsp;
																								<button type="submit" name="salary_status" value="0" class="btn btn-primary">驳回</button>
																							</c:if>
																						</c:forEach>
																					</c:when>
																					<c:when test="${salary.salary_status==2 }">
																						<button type="submit" name="salary_status" value="1" class="btn btn-primary">申请变更</button>
																					</c:when>
																				</c:choose>
																			</div>
																		</div>
