					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">薪酬标准明细</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#toEditSalaryStandard">明细</a>
															</li>
															<li>
													...
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<div class="scrollable-horizontal" data-size="800">
																	...
																	<form  action="${pageContext.request.contextPath }/salary/toSalaryList.gkd" method="post" class="form-horizontal" role="form">
																	    <%--注意：更新必须要有管理员编号 --%>
																		<table>
																	    	<tr>
																	    		<td style="width:450px">
																					<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_code" readonly="readonly" type="text" id="form-field-1" value="${requestScope.salary.salary_code }" placeholder="薪酬标准编号" class="col-xs-10 col-sm-5" style="width: 210px" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_name" readonly="readonly" type="text" placeholder="薪酬标准名称" value="${requestScope.salary.salary_name }" class="col-xs-10 col-sm-5" style="width: 210px" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    	...
																	    	<tr>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_marker" readonly="readonly" type="text" placeholder="制定人" value="${requestScope.salary.salary_marker }" class="col-xs-10 col-sm-5" style="width: 210px" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="admin_account" type="text" readonly="readonly" value="${requestScope.salary.admin.admin_account }" placeholder="登记人" class="col-xs-10 col-sm-5" style="width: 210px" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:450px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="salary_date" class="form-control layer-date" readonly="readonly" value="${requestScope.salary.salary_date }" placeholder="YYYY-MM-DD" style="width: 210px" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																			...
																			<c:forEach var="item" varStatus="status" items="${requestScope.items }">
																	  			...
																	  			<tr class="bolder">
																					...
																					<td>
																						...
																						<input name="salary_item_value" readonly="readonly" type="text" value="${item.salary_item_value }" placeholder="金额" class="col-xs-10 col-sm-5 salaryItemValue" />
																					</td>
																				</tr>
																	  		</c:forEach>
																			<c:set var="xh" value="0"></c:set>
