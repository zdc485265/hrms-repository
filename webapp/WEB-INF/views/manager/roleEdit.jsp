					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">编辑角色</h4>
														...
														<div class="tab-content padding-4">
															...
															<div id="roleAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																      <p style="color: red;">${requestScope.role_edit_msg }</p>
																	<form action="${pageContext.request.contextPath }/role/editRole.gkd" method="post"  class="form-horizontal" role="form">
																	    <%--注意：更新必须要有管理员编号 --%>
																	    <input name="role_id" value="${requestScope.role.role_id }" type="hidden">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 角色名 : </label>

																			<div class="col-sm-9">
																				<input name="role_name" value="${requestScope.role.role_name }" type="text" id="form-field-1" placeholder="角色名" class="col-xs-10 col-sm-5" /><p style="color: red;">*</p>
																			</div>
																		</div>
																			    ...
																			    <table class="table">
																			      ...
																			      <c:forEach var="power" items="${modular.powers}">
																			         <c:if test="${count%4==0 }">
																				       ...
																				       <%--迭代判断，当前编辑的角色有没有的包含本次循环的权限，如果有，就修改为true --%>
																				       <c:forTokens var="role_power_id" items="${role.role_powers }" delims=",">
																				           
																				                <c:if test="${role_power_id==power.power_id }">
																				       ...
																				       <%--
																				           如果当前编辑的角色有本次循环的权限，那么就选中，否则就不选中
																				        --%>
																				       <c:choose>
																				          <c:when test="${flag==true }">
																				              <td>${power.power_name }<input name="powerIds" value="${power.power_id }" checked="checked" type="checkbox" /></td>
																				          </c:when>
																				          <c:otherwise>
