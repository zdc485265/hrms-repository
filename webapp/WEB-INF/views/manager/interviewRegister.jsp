					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">面试结果登记</h4>
													...
													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															...
															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/interview/toInterviewList.gkd'">列表</a>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<p style="color: red;">${requestScope.interview_register_msg }</p>
															<div id="recruitResumeAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" style="width:140px;" id="jobCode" name="jobCode" type="text" id="form-field-1" value="${requestScope.resume.job.job_code }" class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly="readonly" style="width:100px;" id="classifyName" name="classify_name" type="text" id="form-field-1" value="${requestScope.resume.job.classify.classify_name}" class="col-xs-10 col-sm-5" />
																						</div>
																					</div>
																	    		</td>
																	    		</tr>
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:400px">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input name="resume_login_date" value="${requestScope.resume.resume_login_date }" readonly="readonly" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    	</tr>
																	...
																	<form action="${pageContext.request.contextPath }/interview/registerInterview.gkd" method="post" class="form-horizontal" role="form">
																	    <input name="resume_id" value="${resume.resume_id }" type="hidden">
																	    <table style="margin-left: 100px">
																	    	<tr>
																	    		<td style="width:400px;">
																	    			<div class="form-group">
																						<label class="col-sm-3 control-label no-padding-right" style="width: 77px;padding-left: 0px" for="form-field-1"> 简历状态:</label>
			
																						<div class="col-sm-9">
																							<select id="sinterview" name="resume_status" onchange="selectInterview()">
																								<c:choose>
																							  	<c:when test="${resume.resume_status==0 }">
																							  		<option value="0" selected="selected">存档</option>
																							  	...
																							  	<c:when test="${resume.resume_status==1 }">
																							  		...
																							  		<option value="1" selected="selected">推荐面试</option>
																							  		<option value="2">推荐二面</option>
																							  		<option value="3">推荐三面</option>
																							  		<option value="4">建议录用</option>
																							  		<option value="5">录用</option>
																							  	...
																							  	<c:when test="${resume.resume_status==2 }">
																							  		<option value="0">存档</option>
																							  		<option value="1">推荐面试</option>
																							  		<option value="2" selected="selected">推荐二面</option>
																							  		<option value="3">推荐三面</option>
																							  		<option value="4">建议录用</option>
																							  		<option value="5">录用</option>
																							  	</c:when>
																							  	<c:when test="${resume.resume_status==3 }">
																							  		...
																							  		<option value="1">推荐面试</option>
																							  		<option value="2">推荐二面</option>
																							  		<option value="3" selected="selected">推荐三面</option>
																							  		<option value="4">建议录用</option>
																							  		<option value="5">录用</option>
																							  	</c:when>
																							  	<c:when test="${resume.resume_status==4 }">
																							  		...
																							  		<option value="2">推荐二面</option>
																							  		<option value="3">推荐三面</option>
																							  		<option value="4" selected="selected">建议录用</option>
																							  		<option value="5">录用</option>
																							  	</c:when>
																							  	<c:when test="${resume.resume_status==5 }">
																							  		...
																							  		<option value="3">推荐三面</option>
																							  		<option value="4">建议录用</option>
																							  		<option value="5" selected="selected">录用</option>
																							  	</c:when>
																							  </c:choose>
																							</select>
																						</div>
																	    	...
																	    	<tr>
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 一面面试人:</label>
							
																						<div class="col-sm-6">
																						<c:set var="c1a" value="0"/>
																								<c:forEach var="interview" items="${interviews }">
																										<c:if test="${interview.interview_status==2 }">
																											<input name="interview_id1" value="${interview.interview_id }" type="hidden"/>
																											<input readonly="readonly" style="width:100px" name="admin_account1" type="text" id="form-field-1" value="${interview.admin.admin_account }" class="col-xs-10 col-sm-5" />
																											<c:set var="c1a" value="1"/>
																										</c:if>
																									</c:forEach>
																										<c:if test="${c1a==0 }">
																										<input readonly="readonly" style="width:100px" name="admin_account1" type="text" id="form-field-1" value="${admin.admin_account }" placeholder=" 一面面试人 " class="col-xs-10 col-sm-5" />
																										</c:if>
																	    		...
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 面试时间:</label>
			
																						<div class="col-sm-6">
																						<c:set var="c1d" value="0"/>
																								<c:forEach var="interview" items="${interviews }">
																										<c:if test="${interview.interview_status==2 }">
																											<input name="interview_date1" value="${interview.interview_date }" readonly="readonly" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																											<c:set var="c1d" value="1"/>
																										</c:if>
																									</c:forEach>
																										<c:if test="${c1d==0 }">
																										<input name="interview_date1" class="form-control layer-date" value="${requestScope.newDate }" readonly="readonly" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																										</c:if>
																	    		...
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						<label style="width:120px;" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 一面面试评价:</label>
			
																						<div class="col-sm-6">
																							<c:set var="c1i" value="0"/>
																							<c:forEach var="interview" items="${interviews }">
																										<c:if test="${interview.interview_status==2 }">
																												<textarea readonly="readonly" class="v1" style="width:439px;height: 100px;left: 10px" name="interview_info1">${interview.interview_info }</textarea>
																												<c:set var="c1i" value="1"/>
																										</c:if>
																									</c:forEach>
																									<c:if test="${c1i==0 }">
																										<textarea readonly="readonly" class="v1" style="width:439px;height: 100px;left: 10px" name="interview_info1"></textarea>
																									</c:if>
																	    		...
																	    		<tr>
																	    			<td style="width:20%">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 二面面试人:</label>
			
																						<div class="col-sm-6">
																						<c:set var="c2a" value="0"/>
																									<c:forEach var="interview" items="${interviews }">
																										<c:if test="${interview.interview_status==3 }">
																											<input name="interview_id2" value="${interview.interview_id }" type="hidden"/>
																											<input readonly="readonly" style="width:100px" name="admin_account2" type="text" id="form-field-1" value="${interview.admin.admin_account }" class="col-xs-10 col-sm-5" />
																											<c:set var="c2a" value="1"/>
																										</c:if>
																									</c:forEach>
																										<c:if test="${c2a==0 }">
																										<input  readonly="readonly" style="width:100px" name="admin_account2" type="text" id="form-field-1" value="${admin.admin_account }" placeholder=" 二面面试人 " class="col-xs-10 col-sm-5" />
																										</c:if>
																	    		...
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																						<c:set var="c2d" value="0"/>
																									<c:forEach var="interview" items="${interviews }">
																										<c:if test="${interview.interview_status==3 }">
																											<input name="interview_date2" value="${interview.interview_date }" readonly="readonly" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																											<c:set var="c2d" value="1"/>
																										</c:if>
																									</c:forEach>
																										<c:if test="${c2d==0 }">
																										<input name="interview_date2" class="form-control layer-date" placeholder="YYYY-MM-DD" value="${requestScope.newDate }" readonly="readonly" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																										</c:if>
																	    		...
																	    		<tr>
																	    			<td style="width:500px;" colspan="2">
																	    			<div class="form-group">
																						<label style="width:120px;" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 二面面试评价:</label>
			
																						<div class="col-sm-6">
																							<c:set var="c2i" value="0" />
																							<c:forEach var="interview" items="${interviews }">
																								<c:if test="${interview.interview_status==3 }">
																										<textarea readonly="readonly" class="v2" style="width:439px;height: 100px;left: 10px" name="interview_info2">${interview.interview_info }</textarea>
																										<c:set var="c2i" value="1" />
																								</c:if>
																							</c:forEach>
																							<c:if test="${c2i==0 }">
																								<textarea readonly="readonly" class="v2" style="width:439px;height: 100px;left: 10px" name="interview_info2"></textarea>
																							</c:if>
																	    		...
																	    		<td style="width:240px;">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1">三面面试人:</label>
			
																						<div class="col-sm-6">
																								<c:set var="c3a" value="0"/>
																								<c:forEach var="interview" items="${interviews }">
																									<c:if test="${interview.interview_status==4 }">
																										<input name="interview_id3" value="${interview.interview_id }" type="hidden"/>
																										<input readonly="readonly" style="width:100px" name="admin_account3" type="text" id="form-field-1" value="${interview.admin.admin_account }" class="col-xs-10 col-sm-5" />
																										<c:set var="c3a" value="1" />
																									</c:if>
																								</c:forEach>
																								<c:if test="${c3a==0 }">
																									<input readonly="readonly" style="width:100px" name="admin_account3" type="text" id="form-field-1" value="${admin.admin_account }" class="col-xs-10 col-sm-5" />
																								</c:if>	
																	    		...
																	    		<td style="width:240px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																						<c:set var="c3d" value="0"></c:set>
																							<c:forEach var="interview" items="${interviews }">
																								<c:if test="${interview.interview_status==4 }">
																									<input name="interview_date3" value="${interview.interview_date }" readonly="readonly" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																									<c:set var="c3d" value="1"></c:set>
																								</c:if>
																							</c:forEach>
																							<c:if test="${c3d==0 }">
																								<input name="interview_date3" class="form-control layer-date" value="${requestScope.newDate }" readonly="readonly" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																							</c:if>
																	    		...
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						<label style="width:120px;" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 三面面试评价:</label>
			
																						<div class="col-sm-6">
																							<c:set var="c3i" value="0" />
																							<c:forEach var="interview" items="${interviews }">
																								<c:if test="${interview.interview_status==4 }">
																										<textarea readonly="readonly" class="v3" style="width:439px;height: 100px;left: 10px" name="interview_info3">${interview.interview_info }</textarea>
																										<c:set var="c3i" value="1"/>
																								</c:if>
																							</c:forEach>
																								<c:if test="${c3i==0 }">
																									<textarea readonly="readonly" class="v3" style="width:439px;height: 100px;left: 10px" name="interview_info3"></textarea>
																								</c:if>
...
<![endif]-->
		...
		<script type="text/javascript">
			function selectInterview(){
				$(".v1").prop("readonly","readonly");
				$(".v2").prop("readonly","readonly");
				$(".v3").prop("readonly","readonly");
				var val=$("#sinterview").val();
				if(val==2){
					$(".v1").removeAttr("readonly");
				}else if(val==3){
					$(".v1").removeAttr("readonly");
					$(".v2").removeAttr("readonly");
				}else if(val==4){
					$(".v1").removeAttr("readonly");
					$(".v2").removeAttr("readonly");
					$(".v3").removeAttr("readonly");
				}
			}
