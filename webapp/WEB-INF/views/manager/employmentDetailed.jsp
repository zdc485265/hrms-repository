					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">录用明细</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#">明细</a>
															</li>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<p style="color: red;">${requestScope.employment_detailed_msg }</p>
															<div id="recruitResumeAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	...
																	<form action="${pageContext.request.contextPath }/employment/toEmploymentList.gkd" method="post" class="form-horizontal" role="form">
																	    	...
																	    	<tr>
																	    		...
																	    		<tr>
																	    			...
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																								<textarea class="v2" readonly="readonly" style="width:439px;height: 100px;left: 10px" name="employment_info">${employment.employment_info }</textarea>
