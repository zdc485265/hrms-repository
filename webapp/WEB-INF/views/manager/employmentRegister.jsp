					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">录用登记</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#">登记</a>
															</li>

													

															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/employment/toEmploymentList.gkd'">列表</a>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<p style="color: red;">${requestScope.employment_register_msg }</p>
															<div id="recruitResumeAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	...
																	<form action="${pageContext.request.contextPath }/employment/registerEmployment.gkd" method="post" class="form-horizontal" role="form">
																	    	...
																	    	<tr>
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input readonly="readonly" style="width:100px" name="adminAccount1" type="text" id="form-field-1" value="${interview1.admin.admin_account }" class="col-xs-10 col-sm-5 v1" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input name="interview_date1" value="${interview1.interview_date }" readonly="readonly" class="form-control layer-date v1" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		...
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																						<textarea readonly="readonly" class="v1" style="width:439px;height: 100px;left: 10px" name="interview_info1">${interview1.interview_info }</textarea>
																	    		...
																	    		<tr>
																	    			...
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input readonly="readonly" style="width:100px" name="admin_account2" type="text" id="form-field-1" value="${interview2.admin.admin_account }" class="col-xs-10 col-sm-5 v2" />
																	    		...
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input name="interview_date2" value="${interview2.interview_date }" readonly="readonly" class="form-control layer-date v2" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																	    		...
																	    		<tr>
																	    			...
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																								<textarea readonly="readonly" class="v2" style="width:439px;height: 100px;left: 10px" name="interview_info2">${interview2.interview_info }</textarea>
																	    		...
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input readonly="readonly" style="width:100px" name="admin_account3" type="text" id="form-field-1" value="${interview3.admin.admin_account }" class="col-xs-10 col-sm-5 v1" />
																						</div>
																					</div>
																	    		</td>
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input name="interview_date3" value="${interview3.interview_date }" readonly="readonly" class="form-control layer-date v1" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																						</div>
																					</div>
																	    		</td>
																	    		</tr>
																	    		...
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																						<textarea readonly="readonly" class="v1" style="width:439px;height: 100px;left: 10px" name="interview_info3">${interview1.interview_info }</textarea>
																	    		...
																	    		<tr>
																	    			<td style="width:20%">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 决议人:</label>
			
																						<div class="col-sm-6">
																							<c:choose>
																								<c:when test="${employment!=null&&employment!='' }">
																									<input name="employment_id" value="${employment.employment_id }" type="hidden">
																									<input readonly="readonly" style="width:100px" name="admin_account4" type="text" id="form-field-1" value="${employment.admin.admin_account }" class="col-xs-10 col-sm-5" />
																								</c:when>
																								<c:otherwise>
																									<input readonly="readonly" style="width:100px" name="admin_account4" type="text" id="form-field-1" value="${admin.admin_account }" class="col-xs-10 col-sm-5" />
																								</c:otherwise>
																							</c:choose>
																	    		...
																	    		<td style="width:20%">
																	    			<div class="form-group">
																						<label style="width:100px" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 决议时间:</label>
			
																						<div class="col-sm-6">
																							<c:choose>
																								<c:when test="${employment!=null&&employment!='' }">
																									<input name="employment_date" value="${employment.employment_date }" readonly="readonly" class="form-control layer-date v2" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																								</c:when>
																								<c:otherwise>
																									<input name="employment_date" value="${newDate }" readonly="readonly" class="form-control layer-date v2" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																								</c:otherwise>
																							</c:choose>
																	    		...
																	    		<tr>
																	    			<td style="width:500px;" colspan="2">
																	    			<div class="form-group">
																						<label style="width:120px;" class="col-sm-6 control-label no-padding-right" for="form-field-1"> 录用决议:</label>
			
																						<div class="col-sm-6">
																								<textarea class="v2" style="width:439px;height: 100px;left: 10px" name="employment_info">${employment.employment_info }</textarea>
