					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">面试结果明细</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li  class="active">
																<a data-toggle="tab" href="#recruitResumeAdd">明细</a>
															</li>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<p style="color: red;">${requestScope.interview_detailed_msg }</p>
															<div id="recruitResumeAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	...
																	<form action="${pageContext.request.contextPath }/interview/toInterviewDetailed.gkd" method="post" class="form-horizontal" role="form">
																	    	...
																	    	<tr>
																	    		...
																	    		<td style="width:240px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input readonly="readonly" style="width:100px" name="admin_account3" type="text" id="form-field-1" value="${interview3.admin.admin_account }" class="col-xs-10 col-sm-5 v3" />
																	    		...
																	    		<td style="width:240px;">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<input name="interview_date3" value="${interview3.interview_date }" readonly="readonly" class="form-control layer-date v3" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
																	    		...
																	    		<td style="width:500px" colspan="2">
																	    			<div class="form-group">
																						...
																						<div class="col-sm-6">
																							<textarea readonly="readonly" class="v3" style="width:439px;height: 100px;left: 10px" name="interview_info3">${interview3.interview_info }</textarea>
